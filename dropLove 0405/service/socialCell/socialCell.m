...
- (void)setHeight:(NSString *)text{
    ...
    frame.size.height = _labHeight + 80;
    self.frame = frame;
}
- (void)layoutSubviews{
    ...
    self.headerLab.frame = CGRectMake(_headerImg.frame.size.width+_headerImg.frame.origin.x+10, _headerImg.frame.origin.y, 100, 18);
    
    self.contentLab.frame = CGRectMake(_headerLab.frame.origin.x, _headerLab.frame.origin.y+_headerLab.frame.size.height +10, WIDTH_MY- 10 - _headerLab.frame.origin.x, _labHeight);
