//
//  addMemorialDayViewController.m
//  dropLove
//
...
@interface addMemorialDayViewController ()

@end

@implementation addMemorialDayViewController
...
- (void)viewDidLoad {
   ...
   UIBarButtonItem *rightBtn = [[UIBarButtonItem alloc]initWithTitle:@"完成" style:UIBarButtonItemStyleDone target:self action:@selector(overadd:)];
