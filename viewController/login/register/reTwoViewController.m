...
@implementation reTwoViewController
...
- (void)contentTwoMethod{
    ...
    self.registerBtn = [[UIButton alloc]initWithFrame:CGRectMake(10, _passwordText.frame.origin.y+_passwordText.frame.size.height+20, WIDTH-20, 40)];
...
- (void)registerMethod{
    ...
    //验证成功，跳到下一页
                ...
                [dataService registDic:dic andWithSucess:^(NSDictionary *resultDic) {
                    ...
                    marry.phone = _telePnone;
                    marry.password = _passwordText.text;
