...
- (void)viewDidLoad {
    ...
    self.stopclock.backgroundColor = [UIColor yellowColor];
    [self.stopclock setTintColor:[UIColor whiteColor]];
    [self.stopclock setTitle:@"停止" forState:UIControlStateNormal];
...
//    
    ...
    if (hour == huor1 && minute == minute1 && second == 0) {
        ...
        self.view2 = [[UIView alloc]initWithFrame:CGRectMake(0,200, WIDTH_MY, 200)];
        [self.view addSubview:_view2];
        [self.view2 addSubview:_stopclock];
    }
